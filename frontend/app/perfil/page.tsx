...
const Perfil = () => {
    ...
    let mainClasses = "mainContainer border-l " + (screenWidth <= 1024 ? "mt-10" : "");
            ...
            <div className="flex flex-row justify-start items-start" >
                ...
                <main className={mainClasses}>
                    ...
                    <div className="perfilBanner fklex flex-col justify-center items-start w-full h-auto p-20 relative">
                        ...
                        <div className={"flex flex-col justify-center w-full h-1/4 z-50" + (screenWidth <= 1024 ? " items-center" : " items-start")}>
