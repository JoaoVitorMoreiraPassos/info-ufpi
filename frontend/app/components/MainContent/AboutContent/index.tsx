...
const AboutContent = () => {
    return (
        <div className={`flex-column pt-10 mt-8 px-32 ${inria_serif.className}`} >
            <h1 className={'text-2xl pl-6 pb-2'}>Sobre</h1>
            <Image src="/ufpi2.png" alt="Logo" width={1608.37} height={823.45} className=' mix-blend-normal' />
            <div className='mb-20 mt-8'>
                <p className=' aboutContent text-justify text-xl'>
