            ...
            <div className='flex flex-col items-center gap-4' >
                <div className='flex flex-row gap-2 flex-wrap justify-center px-10'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <select name="reg-meal" id="reg-meal" className='h-16 px-4 w-60' placeholder='Refeição Normal' onChange={(e) => {
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <select name="veg-meal" id="veg-meal" className='h-16 px-4 w-60' placeholder='Refeição Vegetariana' onChange={(e) => {
